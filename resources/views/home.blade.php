        ...
        <div class="row gy-5">
            ...
            <div class="col-md-6 ps-4">
                <p class="text-dark m-2">
                    ...
                    :sos: Supply a family with a month's supply of Hot Meals - $56.00<br>
                    :sos: Supply 2 families with a month's supply of Hot Meals - $112.00<br>
                    :sos: Supply 5 families with a month's supply of Hot Meals - $280.00<br>
                    :sos: Supply 10 families with a month's supply of Hot Meals - $560.00<br>
                    :sos: Supply 20 families with a month's supply of Hot Meals - $1,120.00<br>
                    :sos: Emergency Medical Supplies to Hospitals - $200<br>
                    :sos: Emergency Shelter - $500<br>
                    :sos: Emergency Aid Combo (Meals, Water, Aid, Shelter) - $1,000
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="campaign-post">
                    <a>
                        <img src="https://madinah.com/wp-content/uploads/2023/10/Gaza-poster-1-600x500.jpg" class="img-fluid">
                    </a>
                    <div class="campaign-post-content clearfix">
                        <h3>
                            <a>GAZA Emergency Appeal</a>
                        </h3>
                        <span class="entry-author">by iqra</span>
                        <span class="entry-category">in
                            <a href="https://madinah.com/emergency-appeal/" rel="tag">Emergency Appeal</a>
                        </span>
                        <p>PROVIDE BASIC NECESSATIES Under Siege - Gaza is the world's…</p>
                    </div>
                        ...
                        <div class="progress-bar">
                            <div class="lead">
                                <span class="pull-left">
                                    <span>
                                        <bdi><span>$</span>3,938.00</bdi>
                                    </span>
                                    Raised
                                </span>
                                <span class="percentag pull-right">19.69%</span>
                            </div>
                            <div class="progress">
                                <div class="progress-bar progress-bar-primary six-sec-ease-in-out" role="progressbar" data-valuetransitiongoal="19.69" style="width: 19.69%;">
                                </div>
                            </div>
                    ...
                    <div class="campaign-action">
                        <a class="btn btn-custom btn-normal">Donate Now</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4">
